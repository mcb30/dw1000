...
/**
 * dw1000_load_config() - Change radio config parameters
 *
 * @dw:			DW1000 device
 * @return:		0 on success or -errno
 */
...
{
	return ((int)dw->sar.adc.temp - (int)dw->tcalib_23c)
		* 100000 / 114 + 23000;
}
...
{
	return ((int)dw->sar.adc.volt - (int)dw->vcalib_3v3)
		* 1000 / 173 + 3300;
}
...
/**
 * dw1000_game_over() - Stop device after fatal error
 *
 * @dw:			DW1000 device
 */
static void dw1000_game_over(struct dw1000 *dw)
...
/**
 * dw1000_hard_reset() - Perform power cycle reset
 *
 * @dw:			DW1000 device
 */
static void dw1000_hard_reset(struct dw1000 *dw)
{
...
/**
 * dw1000_state_stop() - Stop state machine
 *
 * @dw:			DW1000 device
 * @return:		0 on success or -errno
 */
...
/**
 * dw1000_set_state() - Set state machine state with default timeout
 *
 * @dw:			DW1000 device
 */
static __always_inline void
...
/**
 * dw1000_set_state_timeout() - Set state machine state with state timeout
 *
 * @dw:			DW1000 device
 */
static __always_inline void
...
/**
 * dw1000_enqueue() - Enqueue work item(s)
 *
 * @dw:			DW1000 device
 * @work:		Work bitmap
 */
...
/**
 * dw1000_enqueue_wait() - Enqueue work item(s) and wait for execution
 *
 * @dw:			DW1000 device
 * @work:		Work bitmap
 */
...
/**
 * dw1000_dequeue() - Dequeue work item(s)
 *
 * @dw:			DW1000 device
 * @work:		Work bitmap
 */
...
/**
 * dw1000_enqueue_irq() - Enqueue IRQ work
 *
 * @dw:			DW1000 device
 */
static void dw1000_enqueue_irq(struct dw1000 *dw)
...
/**
 * dw1000_wait_pending_work() - Wait for new work in the queue
 *
 * @dw:			DW1000 device
 */
...
/**
 * dw1000_get_pending_work() - Read work queue state
 *
 * @dw:			DW1000 device
 */
...
/**
 * dw1000_event_thread() - Event handling thread function
 *
 * @dw:			DW1000 device
 * @data:		Thread data
 */
